...
def calculate_feasible_range(file_name, ax):
...
#    print('new states: ', new_states)
    ...
    plot_feasible_range(one_states, zero_states, ax)
    
def plot_feasible_range(one_states, zero_states, ax):
...
def plot_one_model(model, images):
    for image in images:
